...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="shopify"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/zf/ql08_j8x67ndy831xy4by9n40000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/tom_krouper/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/tom_krouper/.mailcheckrc"
# }
