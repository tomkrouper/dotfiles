...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/g9/6tyt7nf541ddpf9_0nmzbmgc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/tom/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/tom/.mailcheckrc"
# }
